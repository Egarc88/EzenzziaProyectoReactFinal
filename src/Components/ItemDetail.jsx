    ...
    return(
        ...
        <div className='detail-container'>
            ...
            { !goToCart ?
               ...
               : <Link to="/cart">
                    <button  className='add-to-cart'>Agregado a tu carrito </button>
                </Link>
        ...
        <div>
    <Link to={'/products/Hombre'} className="back-btn btn-dark">Hombre</Link>
    <Link to={'/products/Dama'} className="back-btn btn-dark">Dama</Link>
    <Link to={'/products/Kids'} className="back-btn btn-dark">Kids</Link>
    </div>
